            ...
            <div className={`backdrop-blur-xl bg-white/50 border border-primary rounded-2xl p-4 sm:p-6 lg:p-8 relative overflow-hidden shadow-2xl ${meowMode ? 'meow-mode-active' : ''}`}>
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="relative w-full py-3 sm:py-4 px-4 sm:px-6 bg-gradient-to-r from-primary to-accent text-white rounded-full font-medium text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 ease-in-out transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl shadow-primary/30 hover:bg-gradient-to-r hover:from-accent hover:to-secondary flex items-center justify-center space-x-2 overflow-hidden group"
                >
